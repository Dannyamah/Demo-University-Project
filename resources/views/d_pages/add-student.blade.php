...
<div class="container">
    ...
    @endforeach
        <div class="col-sm-12">
            <form id="sign_up" action="{{ route('add.student') }}" method="POST" enctype="multipart/form-data"> @csrf
            ...
            <div class="input-group" style="display: none">
                ...
                <div class="form-line">
                    <input type="text" class="form-control" value="1"  name="role_id" placeholder="Role" required="" readonly>
                </div>
            </div>
            <div class="input-group">
                <span class="input-group-addon">
            ...
            <div >
                <div class="dz-message">
                    <div class="drag-icon-cph"> <i class="material-icons">Upload Student
                            Image</i> </div>
                </div>
                <div class="fallback">
            ...
            <div class="input-group">
                <div class="form-group drop-custum">
                    <select name="faculty_id" class="form-control show-tick">
                        <option>-- Select Student Faculty --</option>
