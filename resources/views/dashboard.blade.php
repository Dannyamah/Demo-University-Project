        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="d-sm-flex justify-content-between">
                    <div>
                        <h2>Dashboard</h2>
                        <small class="text-muted">Welcome to Swift University </small>
                    </div>
                    <div>
            ...
            <div class="row clearfix row-deck">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        <img src="d_assets/images/puppy-1.jpg" class="img-fluid card-img-top" alt=" /">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        <img src="d_assets/images/puppy-2.jpg" class="img-fluid card-img-top" alt=" /">
                        <div class="body thumbnail">
                            <div class="caption">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        <img src="d_assets/images/puppy-3.jpg" class="img-fluid card-img-top" alt=" /">
                        <div class="body thumbnail">
                            <div class="caption">
