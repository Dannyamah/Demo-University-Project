<x-guest-layout>
	...
	<!--banner-area start-->
	<div class="banner-area bg-2 overlay mt-40">
		<!--banner-text-->
		<div class="container z-index">
			<div class="row pt-260 pb-200">
				<div class="col-lg-10 offset-lg-1">
					<div class="banner-inner text-center z-index">
						<div class="banner-text style-2 text-white">
							<h1>Offering the best education in the world</h1>
		...
		<!--search-area start-->
		<div class="search-area pd-50 z-index">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="search-box text-center">
							<p>Sign-up today to join over 6 million learners already on Swift</p>
	...
	<!--services-area start-->
	<div class="services-area pt-70 pb-60">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="section-title style-2 text-center">
						<h2>Offering the best <br/> in education to the world</h2>
					</div>
				</div>
			</div>
			<div class="row mt-45">
				<div class="col-lg-3 col-sm-6">
					<div class="service-single text-center">
						...
						<h4>Best Learning Communities</h4>
						<p>The idea is to keep the discussions going after class ends.</p>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="service-single mt-xs-30 text-center">
						<i class="ion-md-moon"></i>
						<h4>Online Teaching Jobs</h4>
						<p>The idea is to keep the discussions going after class ends.</p>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="service-single mt-sm-30 text-center">
